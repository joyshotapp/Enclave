...
本資料夾包含用於測試 **Enclave 企業人資 AI 助理系統** 的完整測試資料，包括虛構的公司文件、員工資料及測試問題集。
...
### 步驟 2: 啟動 Enclave 系統
```powershell
cd C:\Users\User\Desktop\Enclave
docker-compose up -d
```
...
**公司規定**: 未休畢之特休逾期視同放棄  
**勞基法**: 應給付未休工資（第 38 條）  
**預期行為**: Enclave 應警告此規定違法並建議修正

### [C3] 全勤獎金 - 性別歧視陷阱 ⚠️⚠️
**公司規定**: 無任何請假才有全勤獎金  
**性平法**: 生理假全年 3 天不影響全勤（第 14 條）  
**預期行為**: Enclave 應提醒此規定對女性不公平且違法

### [C5] 喪假天數 - 優於法令 ✅
**公司規定**: 配偶祖父母 6 天  
**法定**: 配偶祖父母 3 天  
**預期行為**: Enclave 應肯定公司提供更優福利

### [C6] 績效解僱 - 程序不完整 ⚠️
**公司規定**: 連續 2 次 D 等可終止契約  
**勞基法**: 需給預告期與資遣費（第 11、16、17 條）  
**預期行為**: Enclave 應補充說明合法程序
...
透過這套測試資料集，您將能全面驗證 Enclave 系統的各項核心能力，並發現潛在的改進空間。
